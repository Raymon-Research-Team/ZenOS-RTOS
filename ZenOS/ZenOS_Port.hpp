...
/* CMSIS device capabilities are authoritative; core family alone does not
   guarantee MPU/VTOR/FPU support. */
...
/* A Cortex-M4 MPU has 8 regions; M7/M33 implementations can provide 8 or 16.
   Keep the storage conservative for M4/M3 and use the runtime MPU TYPE value
   to avoid programming more regions than the silicon implements. */
#if defined(__CM4_REV)
    #undef OS_MPU_MAX_REGIONS
    #define OS_MPU_MAX_REGIONS 8
#endif
